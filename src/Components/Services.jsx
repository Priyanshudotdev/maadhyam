  ...
  return (
    <section className=" w-full bg-neutral-950 mt-[5rem] min-h-screen">
      ...
      <div className="relative  ">
        ...
        >
          <div className="top-0 left-0 absolute w-full h-full pointer-events-none md:w-3/5 xl:w-auto rounded-3xl ">
            <img
          ...
          <div className="relative z-1 sm:max-w-[25rem] max-w-[20rem] ml-auto ">
            ...
            <p className=" text-[#c5c5c5] leading-6 md:text-lg mb-[3rem] ">
              "MAADHYAM" represents the voice of innovation, connecting human
              creativity with artificial intelligence. Presented by the{" "}
              <span className="text-[#6366f1]">IT </span>and{" "}
              <span className="text-[#DD335C]">CSD </span>
              department , this magazine explores the evolving relationship
              between humanity and technology, celebrating the fusion of
              imagination and computation.
              <br />
              In-depth articles on AI's role in modern life. Creative
              perspectives from students and faculty. Future-focused tech trends
              and innovations.
            </p>
          </div>
        </motion.div>
      ...
      <div className="relative z-1 grid gap-5 lg:grid-cols-2 ">
        <div className="relative min-h-[39rem] bg-[#111111] rounded-3xl  overflow-hidden ">
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/0 to-n-8/90 lg:p-15 ">
            ...
            <p className=" text-[#c5c5c5] leading-6 md:text-lg mb-[3rem] ">
              From AI-powered healthcare to ethical dilemmas in machine
              learning, our magazine delves into the profound ways AI is
              reshaping the human experience. Be it innovation or introspection,
              discover it here.
            </p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-3xl overflow-hidden bg-zinc-900/30 lg:min-h-[46rem] ">
          <div className="py-12 px-4 xl:px-8 ">
            ...
            <p className=" text-[#c5c5c5] leading-6 md:text-lg mb-[3rem] ">
              We envision a world where human intuition and AI’s precision work
              together to build a harmonious, tech-driven future.
