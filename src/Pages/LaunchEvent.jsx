    ...
    <section className="w-full bg-neutral-950 mt-20 ">
      <div className="text-center">
        <h1 className="text-white text-3xl md:text-5xl font-bold mb-6">
          <span className="text-[#DD335C]">Maadhyam</span> Launch Event
        </h1>
        ...
        >
          <div className="relative z-10 text-center text-white">
            <div className="flex justify-center gap-8 text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <div>
                <span className="block text-[#DD335C]">{days}</span>
                <span className="block text-gray-400 text-sm md:text-lg">
                  Days
                </span>
              </div>
              <div>
                <span className="block text-[#6366f1]">{hours}</span>
                <span className="block text-gray-400 text-sm md:text-lg">
                  Hours
                </span>
              </div>
              <div>
                <span className="block text-[#9105FF]">{minutes}</span>
                <span className="block text-gray-400 text-sm md:text-lg">
                  Minutes
                </span>
              </div>
              <div>
                <span className="block text-[#480CA8]">{seconds}</span>
                <span className="block text-gray-400 text-sm md:text-lg">
                  Seconds
                </span>
              </div>
            ...
            <p className="text-gray-300 md:text-lg">
              Join us as we launch a groundbreaking magazine exploring{" "}
              <span className="text-[#DD335C]">Human-AI Interaction</span>.
            </p>
          </div>
